...
growth_hacking = Product.create(title: "Growth Hacking", subtitle: "Crash Course", author: "Mattan Griffel", price: "4.99", sku: "GROHACK1", details: "You'll get one video", description: %{
    ...
    <ul class="no-indent">
		...
		<p>Hey, I'm Mattan Griffel, co-founder of the Y Combinator backed <a href="http://www.onemonth.com" target="_blank">One Month</a> where I teach the best selling One Month Rails and One Month Growth Hacking.</p>
                ...
                }, length: "30 minutes", author_image_name: "teacher-image.jpg", download_url: "http://erikdrouhard.com")

growth_hacking_monthly = Product.create(title: "Growth Hacking Monthly", subtitle: "Ongoing Course", author: "Mattan Griffel", price: "4.99", sku: "GROHACK2", details: "We'll charge you monthly for unlimited access!", description: %{
    <p>A growth hacker is a rare combination: someone with the right marketing and technical skills who can come up with clever marketing hacks and also track their results.</p>
    ...
    <ul class="no-indent">
        ...
        <p>Hey, I'm Mattan Griffel, co-founder of the Y Combinator backed <a href="http://www.onemonth.com" target="_blank">One Month</a> where I teach the best selling One Month Rails and One Month Growth Hacking.</p>
                ...
                <p>Follow me on Twitter <a href="https://twitter.com/mattangriffel" target="_blank">@mattangriffel</a></p>
                }, length: "6 months", author_image_name: "teacher-image.jpg", download_url: "http://erikdrouhard.com")